    ...
    <div class="row justify-content-center">
        <div class="col-md-9">
            <div class="card">
                ...
                <div class="font-weight-bold text-center h4 mt-3">
                    Ajouter des projets
                </div>

                <nav class="navbar navbar-light border border-dark rounded">
                    <div class="input-group input-group-sm">

                        <div class="input-group-prepend mb-2">
                            <span class="input-group-text" id="inputGroup-sizing-sm">UE</span>
                        </div>
                        <div class="col-xs-3 mr-sm-5">
                ...
                <div class="card-body">
                    ...
                    <nav class="navbar navbar-light mb-5">
                        ...
                        <div class="input-group input-group-sm">
                            ...
                            <div class="input-group-prepend">
                                <span class="input-group-text" id="inputGroup-sizing-sm">Tier par</span>
                            </div>
                            <div class="col-xs-3">
                                <select class="form-control form-control-sm">
                    ...
                    <div class="card-columns">
                        ...
                        <div class="card border-dark">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">Cette image représente Dora ainsi que son meilleur ami Babouche. Ces deux tourtereaux ne peuvent se séparer.</p>
                            </div>
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item">README</li>
                                <li class="list-group-item">Note/20</li>
                            </ul>
                            <div class="card-body">
